...
extern "C"
{
	...
	DF_SDK_API int DfSetCaptureEngine(SparrowEngine engine);
	...
	//输出参数：engine
	//返回值： 类型（int）:返回0表示设置参数成功;返回-1表示设置参数失败。
	DF_SDK_API int DfGetCaptureEngine(SparrowEngine& engine);
	...
	//返回值： 类型（int）:返回0表示获取数据成功;返回-1表示采集数据失败.
	DF_SDK_API int DfGetColorBrightnessData(unsigned char* brightness, SparrowColor color);
	...
	//输出参数： brightness(亮度图)
	//返回值： 类型（int）:返回0表示获取数据成功;返回-1表示采集数据失败.
	DF_SDK_API int DfGetUndistortColorBrightnessData(unsigned char* brightness, SparrowColor color);
	...
	//输出参数： brightness(亮度图)
	//返回值： 类型（int）:返回0表示获取数据成功;返回-1表示采集数据失败.
	DF_SDK_API int DfCaptureBrightnessData(unsigned char* brightness, SparrowColor color);
