...
int handle_cmd_get_frame_06_repetition_black(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame06RepetitionMono12(repetition_count);
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
...
int handle_cmd_get_frame_06_repetition_color_black(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame06RepetitionColorMono12(repetition_count);
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //ret = scan3d_.captureFrame06RepetitionColorMono12(repetition_count);
...
int handle_cmd_get_frame_06_repetition_color(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame06RepetitionColor(repetition_count);
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
...
int handle_cmd_get_frame_06_hdr_color(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame06HdrColor();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //reboot_lightcraft();
...
int handle_cmd_get_frame_06_black(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame06Mono12();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //reboot_lightcraft();
...
int handle_cmd_get_frame_06_hdr_black(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame06HdrMono12();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //reboot_lightcraft();
...
int handle_cmd_get_frame_06_hdr(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame06Hdr();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //reboot_lightcraft();
...
int handle_cmd_get_frame_04_hdr_parallel_mixed_led_and_exposure(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame04HdrBaseConfidence();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
...
int handle_cmd_get_frame_06_repetition(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        LOG(INFO) << "The second collection begins";
        ret = recapture([&]() {
            return scan3d_.captureFrame06Repetition(repetition_count);
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
        //reboot_lightcraft();
...
int handle_cmd_get_frame_04_repetition_02_parallel(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame04Repetition02BaseConfidence(repetition_count);
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
...
int handle_cmd_get_frame_06_color(int client_sock)
{
    ...
    LOG(INFO)<<"captureFrame06_color"; 
    ret = scan3d_.captureFrame06Color();
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame06Color();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
...
int handle_cmd_get_frame_04_parallel(int client_sock)
{
    ...
    if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret) {
        ...
        ret = recapture([&]() {
            return scan3d_.captureFrame04BaseConfidence();
            });
        if (DF_ERROR_CAMERA_GRAP == ret || DF_ERROR_LOST_TRIGGER == ret)
            return DF_FAILED;
