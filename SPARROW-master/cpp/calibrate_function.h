...
public:
	...
	bool writeCalibTxt_45(cv::Mat camera_intrinsic, cv::Mat camera_distortion, cv::Mat projector_instrinsic, cv::Mat projector_distortion, cv::Mat s_r, cv::Mat s_t, std::string path);
	...
	std::vector<cv::Point3f> generateAsymmetricWorldFeature_45(struct BoardMessage board_message);
