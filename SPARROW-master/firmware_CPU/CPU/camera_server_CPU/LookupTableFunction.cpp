...
bool LookupTableFunction::generate_pointcloud_depth(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1,cv::Mat xL_rotate_y1,cv::Mat rectify_R11,cv::Mat pattern_mapping1,float b) {
	...
	for (int yc = 0; yc < img_height; yc++) {
		...
		for (int xc = 0; xc < img_width; xc++) {
			...
			if (ptr_m[xc] > confidence && Z_L > 10 && Z_L < 3000 && Xp > 0)
			{
				ptr_xyz[xc][0] = X_L;
				ptr_xyz[xc][1] = Y_L;
				ptr_xyz[xc][2] = Z_L;
...
bool LookupTableFunction::generate_pointcloud_depth_confidence(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b) {
...
bool LookupTableFunction::generate_pointcloud_depth_black(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b) {
...
bool LookupTableFunction::generate_pointcloud_depth_repetition(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b) {
