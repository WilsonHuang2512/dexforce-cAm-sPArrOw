...
float d_confidence_ = 10;

int d_dlp_width_ = 0;
int d_dlp_height_ = 0;
float d_max_phase_ = 2* CV_PI; 
float d_min_z_ = 10; 
float d_max_z_ = 4500;
...
float bilinear_interpolation(float x, float y, int map_width, float *mapping)
{
...
float mini_bilinear_interpolation(float x, float y, int map_width, float *mapping)
{
	//map_width = 129;
