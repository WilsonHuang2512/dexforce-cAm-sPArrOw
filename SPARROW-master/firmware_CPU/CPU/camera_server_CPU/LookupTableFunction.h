...
public:
	...
	bool generate_pointcloud_depth(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1,float b);
	bool generate_pointcloud_depth_confidence(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b);

	bool generate_pointcloud_depth_repetition(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b);
	bool generate_pointcloud_depth_black(int confidence,cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b);
