...
public:
	...
	bool decodeMinswGrayCode_black(cv::Mat patterns, int space, cv::Mat average_brightness, cv::Mat& k_map);
	...
	bool computePhaseShift_repetition_black(std::vector<cv::Mat> patterns, cv::Mat& wrap_map, cv::Mat& mask_map);
	...
	bool unwrapBase2Kmap_black(cv::Mat wrap_map, cv::Mat k2_map, cv::Mat& unwrap_map);
